...
define view entity ZRAP400_I_BOOKING_AG13
  as select from ZRAP400_BOOKAG13
  association to parent ZRAP400_I_Travel_AG13 as _Travel on $projection.TravelID = _Travel.TravelID
